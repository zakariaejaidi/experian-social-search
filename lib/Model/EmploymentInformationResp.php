...
class EmploymentInformationResp implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['address_first_line'] = isset($data['address_first_line']) ? $data['address_first_line'] : '10655 N BIRCH ST';
        $this->container['address_second_line'] = isset($data['address_second_line']) ? $data['address_second_line'] : 'WASHINGTON DC';
        $this->container['first_reported_date'] = isset($data['first_reported_date']) ? $data['first_reported_date'] : '5011991.0';
        $this->container['last_updated_date'] = isset($data['last_updated_date']) ? $data['last_updated_date'] : '9011991.0';
        $this->container['name'] = isset($data['name']) ? $data['name'] : 'HARDWARE';
        $this->container['source'] = isset($data['source']) ? $data['source'] : '8';
        $this->container['zip_code'] = isset($data['zip_code']) ? $data['zip_code'] : '91502';
    }
