...
class FraudShieldResp implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['address_count'] = isset($data['address_count']) ? $data['address_count'] : '1';
        $this->container['address_date'] = isset($data['address_date']) ? $data['address_date'] : '3011996.0';
        $this->container['address_error_code'] = isset($data['address_error_code']) ? $data['address_error_code'] : '0';
        $this->container['date_of_birth'] = isset($data['date_of_birth']) ? $data['date_of_birth'] : '1101951.0';
        $this->container['date_of_death'] = isset($data['date_of_death']) ? $data['date_of_death'] : '3301996.0';
        ...
        $this->container['social_count'] = isset($data['social_count']) ? $data['social_count'] : '1';
        $this->container['social_date'] = isset($data['social_date']) ? $data['social_date'] : '3011996.0';
        $this->container['social_error_code'] = isset($data['social_error_code']) ? $data['social_error_code'] : null;
        $this->container['ssn_first_possible_issuance_year'] = isset($data['ssn_first_possible_issuance_year']) ? $data['ssn_first_possible_issuance_year'] : '1965';
        $this->container['ssn_last_possible_issuance_year'] = isset($data['ssn_last_possible_issuance_year']) ? $data['ssn_last_possible_issuance_year'] : '1966';
