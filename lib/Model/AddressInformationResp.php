...
class AddressInformationResp implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['census_geo_code'] = isset($data['census_geo_code']) ? $data['census_geo_code'] : '4567890';
        $this->container['city'] = isset($data['city']) ? $data['city'] : 'BURBANK';
        $this->container['county_code'] = isset($data['county_code']) ? $data['county_code'] : '123';
        $this->container['dwelling_type'] = isset($data['dwelling_type']) ? $data['dwelling_type'] : null;
        $this->container['first_reported_date'] = isset($data['first_reported_date']) ? $data['first_reported_date'] : '6011995.0';
        $this->container['last_reporting_subscriber_code'] = isset($data['last_reporting_subscriber_code']) ? $data['last_reporting_subscriber_code'] : '1220855';
        $this->container['last_updated_date'] = isset($data['last_updated_date']) ? $data['last_updated_date'] : '1011998.0';
        $this->container['msa_code'] = isset($data['msa_code']) ? $data['msa_code'] : '0';
        $this->container['source'] = isset($data['source']) ? $data['source'] : null;
        $this->container['state'] = isset($data['state']) ? $data['state'] : 'CA';
        $this->container['state_code'] = isset($data['state_code']) ? $data['state_code'] : '0';
        $this->container['street_name'] = isset($data['street_name']) ? $data['street_name'] : 'BIRCH';
        $this->container['street_prefix'] = isset($data['street_prefix']) ? $data['street_prefix'] : '10655 N';
        $this->container['street_suffix'] = isset($data['street_suffix']) ? $data['street_suffix'] : 'ST';
        $this->container['times_reported'] = isset($data['times_reported']) ? $data['times_reported'] : '1';
        $this->container['unit_id'] = isset($data['unit_id']) ? $data['unit_id'] : null;
        $this->container['unit_type'] = isset($data['unit_type']) ? $data['unit_type'] : 'APT';
        $this->container['zip_code'] = isset($data['zip_code']) ? $data['zip_code'] : '915021234';
    }
